...
#There are differences, with testis tissue looking like an outlier with a much higher number of genes transcribed. This is consistent with an observation called transcriptional scanning, where high transcription is coupled to efficient DNA damage repair, which is important for the testis as this DNA will be inherited by offspring. 
```
```{r}
